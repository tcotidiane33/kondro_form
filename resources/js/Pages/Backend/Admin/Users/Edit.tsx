    ...
    return (
        <AdminLayout>
            <div className="flex justify-center items-center min-h-screen">
                <div className="relative p-4 bg-gray-100 p-2 shadow-md rounded-lg w-full max-w-4xl">
                    ...
                    <form onSubmit={handleSubmit} className="border border-gray-300 p-4 rounded-lg">
