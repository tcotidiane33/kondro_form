                ...
                <ul className="mb-4">
                    {questions.data.map((question) => (
                        <li key={question.id} className="mb-2">
                            <InertiaLink href={route('questions.show', question.id)} className="text-blue-600 hover:underline">
