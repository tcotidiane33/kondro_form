    ...
    return (
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                ...
                <main className="mt-6">
                    <p className='px-10'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat eaque nam, harum deserunt voluptatem odio, accusamus consequuntur fugiat laudantium beatae inventore similique quas, ipsum sed eligendi quae nihil vel! Dolores.</p>
                </main>
                <footer className="py-16 text-center text-sm text-black dark:text-white/70">
                    React TS + VITE + Laravel v{laravelVersion} (PHP v{phpVersion})
                </footer>
                {/* <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
